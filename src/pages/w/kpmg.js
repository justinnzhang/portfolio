    ...
    <>
      ...
      <Container fluid style={{ zIndex: "0" }}>
        <motion.div
          ...
          className
        >
          <Row className="pt-5" style={{ background: highlightColor }}>
            <Container className="">
              <Row>
                <Col sm={6} className="left-first center-on-sm">
                  <h1 className="hero-header" style={{ color: "white" }}>
                    SmartCal - KPMG Ideation Challenge
                  </h1>
                  <h2 className="lg" style={{ color: "white" }}>
                    Representing Ontario on the national stage to answer the
                    question: How might we give back time?
                  </h2>
                ...
                <Col sm={6} className="right-first center-on-sm">
                  <a
                    href="https://youtu.be/LTBv5ETf3HI"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <Button variant="light">See The Video Demo</Button>
                  </a>
                </Col>
              </Row>
          ...
          <Roles
            roles="Product Manager, Technical Lead, Motion Designer, Product
            Desinger"
            team="Angel Huang, Moksha Antani, Omar Kabir, Sarah Huynh,
            Palvisha Sharma"
            tools="GSuite, After Effects, Photoshop, PowerPoint"
          />
            ...
            <Container>
              <Fade bottom duration={666} distance="50px">
                <Row className="text-center ">
                  <Col className="p-5">
                    <p className="font-weight-medium lg">Context</p>
                    <p>
                      This challenge was split into two different parts. I was
                      invited to participate in the first round and put into a
                      team of 6 people from different backgrounds and schools.
                      The second round consisted of working with the same team
                      and competing against 3 other teams from across Canada.
                    </p>
                  </Col>
                </Row>
              </Fade>
              ...
              <Fade bottom duration={666} distance="50px">
                <Row className="mt-5">
                  ...
                  <Col md={8}>
                    ...
                    <p>
                      With only 12 hours to create a product, develop a pitch,
                      and deliver it in front of a panel of judges, we knew that
                      we had to focus our collective efforts on the project at
                      hand.
                    </p>
                    <p>
                    ...
                    <p>
                      ...
                      <strong>
                        How might we decrease time mismanagement that is caused
                        by thinking about and organizing what you have to do,
                        and instead get you focused on actually doing those
                        things?
                      </strong>
                    </p>
                  </Col>
                ...
                <Row className="mt-5">
                  ...
                  <Col md={8}>
                    ...
                    <p>
                      ...
                      employees available to us to refine the product, while
                      also seeing how they all used a very standardized set of
                      tools which could reduce any installation overhead.
                    </p>
                  </Col>
                </Row>
              </Fade>
                ...
                <Row className="mt-5 persona shadow-sm">
                  ...
                  <Col md={8} className="my-auto">
                    ...
                    <p>
                      ...
                      Consulting Practice. She organizes her daily schedule
                      using MS Outlook, Trello, sticky notes, and sometimes a
                      simple mental note to self. Jenny often feels disorganized
                      and finds it burdensome to manually input her tasks and
                      meetings into her calendar to stay on top of things. Not
                      only does this take up valuable time that she could be
                      using on other projects, it is distracting and pulls focus
                      throughout her day. Scheduling meetings through
                      coordinating other coworkers’ calendars is an even bigger
                      pain point.
                    </p>
                  </Col>
                </Row>
            ...
            <Container>
              <Fade bottom duration={666} distance="50px">
                <Row className="mt-5">
                  ...
                  <Col md={8}>
                    <p>
                      An Outlook extension that would learn the user's work
                      habits through Machine Learning, create tasks from emails
                      using Natural Language Processing, and schedule in blocks
                      of time to focus and complete the work.
                    </p>
                    <p>
                      The application would also see what kinds of to-do items
                      already exist, and begin to guide the user towards
                      starting work. This would reduce the need to plan out
                      one's day, while also taking advantage of Deep Focus
                      periods for maximum productivity.
                    </p>
                  </Col>
                </Row>
              </Fade>
                ...
                <Row className="mt-5">
                  ...
                  <Col md={8}>
                    ...
                    <p>
                      ...
                      tool is helping employees stay focused and identify
                ...
                <Row className="mt-5">
                  ...
                  <Col md={8}>
                    <p>
                      ...
                      products (Toggle, Rescue Time, Calendly, Omnifocus,
                      Cortana Scheduler), SmartCal stands out by focusing on
                      personalizing the experience for every user based on their
                      work habits, while also performing the repetitive task of
                ...
                <Row className="mt-5">
                  ...
                  <Col md={8}>
                    <p>
                      ...
                      with my team for our final pitch. This time, we would be
                      up against 3 other teams representing British Columbia,
                      Alberta, and Quebec.
                    </p>
                    <p>
                ...
                <Row className="mt-5">
                  ...
                  <Col md={8}>
                    <p>
                      ...
                      this would be a reasonable investment into employees as
                      such a concept could derive a higher ROI due to
                      productivity increases.
                    </p>
                    <p>
                      Furthermore, from a Customer Lifetime Value perspective,
                      we assumed a 5-year career path for an employee at the
                ...
                <Row className="mt-5">
                  ...
                  <Col md={8}>
                    <p>
                      ...
                      would consist of 2 sprints to build out an MVP with its
                      core features.
                    </p>
                    <p>
                      Next, the program would be pushed out to a select team to
                      begin gathering baseline information and usage habits to
                      provide inputs for a Machine Learning model. The team
                      chosen was an internal group which focuses on the
                      professional development and training for future leaders.
                      This would allow for better future adoption due to
                      decision makers being already familiar with the software.
                    </p>
                    <p>
                      During the testing period, the development team would also
                      be iterating on new features and fixing any issues that
                      come up.
                    </p>
                    <p>
                      With the metrics and a relatively stable product, then we
                      would begin marketing and outreach. Awareness campaigns
                      would be started, and we hope to start onboarding more
                ...
                <Row className="text-center">
                  <Col className="p-5">
                    ...
                    <div className="less-text">
                      ...
                      <p>
                        Although it was disappointing, I am still so grateful
                        for being able to meet and work together with my team.
                        Furthermore, having the opportunity to learn from
                        professionals in the industry gave me a new perspective
                ...
                <Row className="">
                  ...
                  <Col md={8}>
                    <p>
                      ...
                      actual business problem. This exposed me to the nitty
                      gritty of distilling the problem down to its core and
                      testing new hypotheses. Being able to grow my network
                      within the firm, as well as with motivated students from
                      across Canada also allowed me to meet and develop valuable
                      relationships.
                    </p>
                    <p>
                    ...
                    <p className="font-weight-medium lg mt-5">
                      Looking Forward
                    </p>
                    <p>
                      With this experience, I'm looking forward to applying what
                      I learned in future projects, as well as keeping in touch
                      with the amazing individuals that I was able to meet!
                    </p>
