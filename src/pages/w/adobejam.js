          ...
          <Row className="mt-5 ">
            <Col>
              <ParagraphComponent title="Problem Statement" solution={false}>
                ...
                <p>
                  The problem statement was quite open ended, stipulating the
                  need for ease of use and the ability for all members of the
                  family to contribute their thoughts and experiences.
                </p>
                <p>
                  We decided that our approach would be to tackle the issue by
                  creating a stand-alone app for travelers to share their
                  experiences while also providing social engagement features
                  for sharing and tying them back to properties in Airbnb.
                </p>
              </ParagraphComponent>
              ...
              <Container>
                <Fade bottom duration={666} distance="50px">
                  <Row className="mt-5 text-center">
                    <Col className="picture-highlight aa p-5">
                      <p style={{ color: "white" }}>
                        A series of questions and assumptions that we made
                  ...
                  <Row className="mt-5 persona shadow-sm">
                    ...
                    <Col md={8} className="my-auto">
                      ...
                      <p>
                        ...
                        travel. He’s a regular user of Airbnb because he finds
                        it easy to discover new accommodation options. During
                        his trips, he’s always taking pictures with his friends
                        and tagging them in large albums on social media
                        platforms.
                      </p>
                      <p>
                        Jason also loves reading traveler’s blogs and their
                        experiences traveling with friends. He wishes that he
                        can make content like that on his own, without needing
                        to learn complicated design tools.
                      </p>
                    </Col>
                  </Row>
                </Fade>
                  ...
                  <Row className="mt-3 persona">
                    ...
                    <Col md={8} className="my-auto">
                      ...
                      <p>
                        ...
                        two kids are still young, she wants to help preserve
                        their memories. They have started scrapbooking as a way
                        to allow them to participate in the documentation
                        process.{" "}
                      </p>
                      <p>
                        As they have done a lot of things together already,
                        Sally is looking for inspiration for new activities that
                        they can do together. She also wants be able to easily
                        share new experiences and activities with her friends.
                      </p>
                    </Col>
                  </Row>
                </Fade>
              ...
              <ParagraphComponent title="Rough Mockups">
                ...
                <p>
                  We decided to try a new approach with stories, incorporating
                  the simple idea of being able to swipe left and right through
                  content with a new feature: perspectives.
                </p>
                <p>
                  The content would be grouped in a series of up to 10 chapters.
                  Each chapter would consist of a tile, a media item, a
                  location, and a caption. Underneath, any person that took part
                  in the trip would be able to add in their own media and
                  comments; hence adding their perspective.
                </p>
              </ParagraphComponent>
              ...
              <Container>
                <Fade bottom duration={666} distance="50px">
                  <Row className="mt-5 text-center">
                    <Col className="picture-highlight aa p-5">
                      <p style={{ color: "white" }}>
                        A rough wireframe of the core feature of the
